...
str_polz_1=sorted(str_polz_1.lower())#присваинвание сортированного значения
str_polz_2=sorted(str_polz_2.lower())#присваинвание сортированного значения
if str_polz_1==str_polz_2:#сравнивание 
